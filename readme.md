...
```bash
npm install --save-dev tsconfig-jaid@^2.1.0
```
...
```bash
yarn add --dev tsconfig-jaid@^2.1.0
```
...
```bash
npm install --save-dev @jaid/tsconfig-jaid@^2.1.0
```
