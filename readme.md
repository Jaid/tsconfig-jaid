...
```bash
npm install --save-dev tsconfig-jaid@^2.0.1
```
...
```bash
yarn add --dev tsconfig-jaid@^2.0.1
```
...
```bash
npm install --save-dev @jaid/tsconfig-jaid@^2.0.1
```
